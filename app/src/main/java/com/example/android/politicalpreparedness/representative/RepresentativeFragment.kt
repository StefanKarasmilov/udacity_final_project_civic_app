...
class DetailFragment : Fragment() {
    ...
    private lateinit var factory: RepresentativeViewModel.Factory
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        factory = RepresentativeViewModel.Factory(requireNotNull(this.activity).application)
        viewModel = ViewModelProvider(this, factory).get(RepresentativeViewModel::class.java)

        binding.viewModel = viewModel

        setUpSpinnerAdapter()
        setUpRepresentativesAdapter()
        setClickListeners()
    ...
    private fun setUpRepresentativesAdapter() {
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        val dialog = AlertDialog.Builder(requireContext())
                .setTitle("Permission")
                .setMessage("This feature needs a location permission")
